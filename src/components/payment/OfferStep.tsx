...
export const OfferStep = ({ onContinue }: { onContinue: () => void }) => (
  <div>
    <div className="text-center mb-8">
      <div
        className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px] uppercase tracking-widest mb-4"
        style={{
    ...
    >
      ...
      <Button variant="hero" size="xl" className="w-full mt-6" onClick={onContinue}>
        Unlock My Financial Kundli
      </Button>
